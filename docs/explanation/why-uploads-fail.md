...
This is tracked in the [TODO](../TODO.md) and will be removed when upstream PR #7896 merges.
...
- [huggingface/datasets#7896](https://github.com/huggingface/datasets/pull/7896): Fix PR (pending merge)
...
- [TODO](../TODO.md) - Tracking upstream dependency
