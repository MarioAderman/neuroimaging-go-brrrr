...
Download from Zenodo (Record 17652035):

```bash
# Download training set (~99GB)
wget https://zenodo.org/records/17652035/files/train.7z

# Extract (requires p7zip)
7z x train.7z -o data/zenodo/isles24/
```

Expected MD5 checksum for train.7z: `4959a5dd2438d53e3c86d6858484e781`
